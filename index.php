...
body {
			background-image: url('mallick.jpg');
    ...
    .navbar.navbar-expand-lg.navbar-dark.fixed-top a.navbar-brand:hover {
      color: #fff;
      opacity: 0.8;
    }
    .navbar.navbar-expand-lg.navbar-dark.fixed-top .navbar-nav .nav-link:hover {
      color: #fff;
      opacity: 0.8;
    }
    .h3, h3 {
  ...
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;margin-left:-65px;font-family:'IBM Plex Sans', sans-serif;">
        <h4><i class="fa fa-hospital-o" aria-hidden="true"></i><span style="color: #0030e7;font-weight:bold;font-size:31px;"></span>ONLINE <span style="color:red;font-weight:bold">HOSPITAL </span> MANAGEMENT</h4>
      </a>
...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
                <div class="row">
                    <div class="col-md-3 register-left" style="margin-top: 10%;right: 5%">
                        <img src="dr.png" alt=""/>
                        <h3><u>Welcome To <br><span style="color: #0030e7;font-weight:bold;font-size:31px;">O</span>nline<span style="color:red;font-weight:bold"> Hospital </span></u></h3>
                       
                    </div>
                    <div class="col-md-9 register-right" style="margin-top: 40px;left: 80px;border-radius: 35px;background-color:#b6daff70;">
