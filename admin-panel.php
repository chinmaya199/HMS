...
<title>OHM Appointment</title>
    ...
    <link href="https://fonts.googleapis.com/css?family=IBM+Plex+Sans&display=swap" rel="stylesheet">
      <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" style="background-color: black;">
  <a class="navbar-brand" href="#"><i class="fa fa-hospital-o" aria-hidden="true"></i>Online Hospital Management </a>
  ...
  <style >
    ...
    .bg-white {
    background-color: #bbf2ff54!important;
}
.tab-content>.active {
    display: block;
    background-color: #c1d3d300;
}
.table {
    width: 100%;
    margin-bottom: 1rem;
    color: #212529;
    background-color: #9bffff63;
}
...
<div class="tab-pane fade" id="app-hist" role="tabpanel" aria-labelledby="list-pat-list">
                ...
                <tbody>
                  ...
                  ?>
                      <tr>
                        ...
                        <td>
                          <form method="get" action="./aaa/index.php">
      ...
      <div>
        <input type="submit" id="submit-btn" value="pay now" style="background-color: green; color: white; border: none; padding: 10px 20px; border-radius: 5px;">
      </div>
                              </a>
                              </td>
                              </form>
