 ...
 <body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
    <div class="container">
      ...
      <h4><i class="fa fa-hospital-o" aria-hidden="true"></i><span style="color: #0030e7;font-weight:bold;font-size:38px;"></span>ONLINE <span style="color:red;font-weight:bold">HOSPITAL </span> MANAGEMENT</h4>
      </a>
    ...
    animation: mover 1s infinite alternate;">
          <img src="pa.png" alt="" style="width: 20%;padding-left: 40px;margin-top: 150px;margin-left: 45px;margin-bottom:15px">
      </div>

      <div style="color: black; font-weight: bold;">
            <h4 style="font-family: 'IBM Plex Sans', sans-serif;font-weight: bold;font-size: 35px;text-transform: uppercase;"> We are here for you!</h4>
          </div>
