...
<title>OHM Admin</title>
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-hospital-o" aria-hidden="true"></i><u>&nbsp ONLINE<span style="color:red;font-weight:bold">  HOSPITAL </span>MANAGEMENT</u></a>
...
.list-group-item.active {
  ...
  <body style="padding-top:50px;">
   <div class="container-fluid" style="margin-top:50px;">
    <h3 style = "margin-left: 40%;padding-bottom: 20px;font-family: 'IBM Plex Sans', sans-serif;color: red;font-weight: bold;"> WELCOME ADMINISTRATOR </h3>
    <div class="row">
  <div class="col-md-4" style="max-width:25%;margin-top: 3%;">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a  href="./ROZ/index.php" class="list-group-item list-group-item-action"  >paymentStatus</a>
    </div><br>
  </div>
